      ...
      if (results[answer.questionId].type === 'CHECKBOX') {
        answer.markedAnswers.forEach(optionId => {
          ...
          if (typeof results[answer.questionId].answers[optionId] === 'undefined') {
            results[answer.questionId].answers[optionId] = {name: optionData.title, value: 0, id: optionId}
          }
        ...
        if(answer.markedAnswers.length > 0) {
          if (typeof results[answer.questionId].answers[answer.markedAnswers[0]] === 'undefined') {
            results[answer.questionId].answers[answer.markedAnswers[0]] = {name: optionData.title, value: 0, id: answer.markedAnswers[0]}
          }
          ...
          if ( typeof results[answer.questionId].answers.other === 'undefined') {
            results[answer.questionId].answers.other = {name: 'other', value: 0, id: 'other'}
          }
        ...
        if (typeof results[answer.questionId].answers[answer.customAnswer] === 'undefined') {
          results[answer.questionId].answers[answer.customAnswer] = {name: optionData.title, value: 0, id: answer.customAnswer}
        }
        ...
        if (typeof results[answer.questionId].answers[answer.customAnswer] === 'undefined') {
          results[answer.questionId].answers[answer.customAnswer] = {name: answer.customAnswer, answers: 0, id: answer.customAnswer}
        }
