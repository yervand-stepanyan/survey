...
export const TEXT_LABELS = {
  ...
  questionCreatorInfoTooltipMessage: 'Input question!',
  ...
  rangeSectionEndValueInfoTooltipMessage: 'Input end value!',
  ...
  rangeSectionStepValueInfoTooltipMessage: 'Input step value!',
  ...
  surveyTitleCreatorInfoTooltipMessage: 'Input survey title!',
